...
XASXESXPS_pp_dict = {
    "left": -40,
    "right": 40,
    "output_filename": "XASXESXPS_composite.png"
}
...
# Quick and dirty XAS, XES, and XPS plot
plot_utils.make_QuantyPlots_XASXESXPS_simple("LFMcalc_general", {**XASXESXPS_pp_dict, **plot_params_dict})
...
image_paths = ["header.png", "XASXESXPS_composite.png"]
