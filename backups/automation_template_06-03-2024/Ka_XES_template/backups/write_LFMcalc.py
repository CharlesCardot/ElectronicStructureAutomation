...
#filename = parent_dir / str("output/%s/LFMcalc/3_XAS.Quanty" % (NAME))
...
#with open("/home/ccardot3/QuantyScripts/automation/utils/TM_ZETA_3P.json","r") as f:
#    TM_ZETA_3P = json.load(f)
...
for key, line in enumerate(lines):
    ...
    #line = line.replace("TM_ZETA_3P",str(TM_ZETA_3P[material_input["TM"]]))
