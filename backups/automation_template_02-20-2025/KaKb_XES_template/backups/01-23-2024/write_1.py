...
dft_dir = "/home/ccardot3/QuantyScripts/automation/output/%s/DFT/" % (NAME)
...
filename = "/home/ccardot3/QuantyScripts/automation/output/%s/1_Run%sFPLO_WF.Quanty" % (NAME,NAME)
